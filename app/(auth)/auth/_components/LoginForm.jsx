    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            try {
                ...
                const fullUserData = {
                    ...userProfile, // Include role and other fields
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <Input
                ...
                classNames={{
                    ...
                    input: "text-gray-900",
                    inputWrapper: "border-gray-300 hover:border-blue-400 focus-within:!border-blue-500 data-[hover=true]:border-blue-400",
                }}
                variant="bordered"
            />
            ...
            <div className="flex items-center justify-between text-sm">
                ...
                <button type="button" className="font-medium text-blue-600 hover:text-blue-700 transition-colors">
                    Quên mật khẩu?
                </button>
            </div>
            ...
            <Button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 font-semibold text-white shadow-lg transition-all hover:shadow-xl"
                size="lg"
            >
